...
highchart() %>%
  hc_add_series(cbind(t, signal1), name = "Señal 1 (cos(10πt))") %>%
  hc_add_series(cbind(t, signal2), name = "Señal 2 (cos(20πt))") %>%
  hc_add_series(cbind(t, signal3), name = "Señal 3 (Combinación de senos)") %>%
  hc_add_series(cbind(t, multiplexed_signal), name = "Señal Multiplexada", color = "#FF5733") %>%
